...
#define BOARD_UMS_LUNFILE    "/sys/devices/platform/sw_usb_udc/gadget/lun0/file"
#define BOARD_UMS_LUN2FILE   "/sys/devices/platform/sw_usb_udc/gadget/lun1/file"
#endif
...
void show_mount_usb_storage_menu()
{
    ...
    if ((fd2 = open(BOARD_UMS_LUN2FILE, O_WRONLY)) < 0) {
